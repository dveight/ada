...
def setup_init():
    """
    Performs all necessary setup for ada to work within Nuke's terminal mode
    """
...
def setup_menu():
    """
    Performs all necessary setup for ada to work within Nuke's gui mode
    """
    # Right-mouse Ada/Bake menu for knobs derived from nuke.Array_Knob
